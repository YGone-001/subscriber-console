 ...
 * 4. System Invariants (ACTUALLY_ROUTED = 36, single-writer production ownership, charging plane boundary)
 */
...
try {
  ...
  // 4.1 CUTOVER_TABLE count must be strictly 36
  assert.equal(CUTOVER_TABLE.length, 36, `CUTOVER_TABLE count must be exactly 36, found ${CUTOVER_TABLE.length}`);
  recordCheck('invariants.actually_routed_strictly_36');
