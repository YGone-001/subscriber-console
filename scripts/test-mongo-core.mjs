...
const configuredXcloudDbName = process.env.MONGODB_XCLOUD_DB || DEFAULT_MONGODB_DB;
...
const dbName = explicitTestDb || `${configuredXcloudDbName}_core_test_${Date.now()}_${process.pid}`;
