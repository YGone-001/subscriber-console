...
const RISK_CATALOG: Readonly<Record<ApprovalAction, RiskRule>> = {
  ...
  TARIFF_PLAN_CREATE: { level: 'high', reasons: ['Adds a charging tariff plan'] },
  TARIFF_PLAN_UPDATE: { level: 'high', reasons: ['Changes an active charging tariff plan'] },
  TARIFF_PLAN_DELETE: { level: 'critical', reasons: ['Removes a charging tariff plan'] },
  TARIFF_PLAN_RULE_CREATE: { level: 'high', reasons: ['Adds a charging tariff rule'] },
  TARIFF_PLAN_RULE_UPDATE: { level: 'high', reasons: ['Changes an active charging tariff rule'] },
  TARIFF_PLAN_RULE_DELETE: { level: 'critical', reasons: ['Removes a charging tariff rule'] },
  TARIFF_PLAN_RULE_TOGGLE: { level: 'high', reasons: ['Changes a charging tariff rule state'] },
