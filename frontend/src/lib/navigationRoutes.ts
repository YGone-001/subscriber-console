...
export const NAVIGATION_ROUTES: readonly NavigationRoute[] = [
  ...
  { path: "/ocs/subscribers", labelKey: "nav_ocs_subscribers", commandDescriptionKey: "ocs_subscribers_desc", icon: Users, group: "ocs", groupLabelKey: "nav_ocs", groupPath: "/ocs/dashboard", showInCommandPalette: false },
  { path: "/ocs/sessions", labelKey: "nav_ocs_sessions", commandDescriptionKey: "ocs_sessions_desc", icon: Radio, group: "ocs", groupLabelKey: "nav_ocs", groupPath: "/ocs/dashboard", showInCommandPalette: false },
  { path: "/ocs/usage", labelKey: "nav_ocs_usage", commandDescriptionKey: "ocs_usage_desc", icon: Receipt, group: "ocs", groupLabelKey: "nav_ocs", groupPath: "/ocs/dashboard", showInCommandPalette: false },
